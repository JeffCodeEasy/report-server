                ...
                columns: [
                    ...
                    },
                    {
                        text: [
                                ...
                                `Fecha del recibo: ${DateFormatter.getDDMMMYYYY(data.order_date)}
                                Pagar antes de: ${DateFormatter.getDDMMMYYYY(new Date())}`,
                            ],
                        alignment: 'right',
                    }
                ],
            },
            { qr: 'https://www.youtube.com/@JeremyDevHack-2025', fit: 70, alignment: 'right' },
            {
                text: [
                    {text: `Cobrar a:\n`, style: 'subHeader'},
                ...
                table: {
                    ...
                    body: [
                        ...
                        ...order_details.map((detail) => [
                            ...
                            CurrencyFormatter.formatCurrency(+detail.products.price.toString()),
                            {
